          ...
          <VStack  /* boxShadow={'0px 4px 8px rgba(0, 0, 0, 0.2)'} */
             textAlign={'center'} justifyContent={'space-evenly'}>
              <Box p={'1.2rem'} /* border={'solid red 1px'} */ boxShadow={{base : 'none', sm:'0px 4px 8px rgba(0, 0, 0, 0.2)'}} w={'100%'}>
                ...
                <Box w={'100%'} mb={'20px'}  as="form" onSubmit={sendData} display={'flex'} flexDirection={'column'} gap={'1rem'} p={'1rem 1rem 0'} noValidate >
                    ...
                    <Button type="submit" h={'35px'} borderRadius={'7px'} bg={'#4cb5f9'}
                      p={'.9rem'} fontWeight={'bolder'} color={'aliceblue'}
                    >registrarte</Button>          
                </Box>
                {errors ? errors?.map((er, ind) => 
                    <Text  color={'red'} fontSize={'xs'} key={ind}>{er}</Text>) 
                    : null}
              </Box>
